...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Sign in with your <span class="text-green">KBANKNET</span></p>
  ...
  <!-- /.login-box-body -->
        ...
        <p style="color: gray; float: right; font-size: xx-small; margin-top: 15px;" class="ng-binding">Version $major.$minor.$build.$seq</p>
